...
<title>Organization Forms Details</title>
...
<body>
	...
	<div class="container mt-5">
		...
		<form:form action="adddetails" method="post"
			...
			<div class="form-group">
				<form:input path="comName" size="50" cssClass="form-control"
			...
			<div class="form-group">
				...
				<form:select path="designation" multiple="true">
				...
				<form:errors path="designation" cssClass="errormsg" />

			</div>
			
			<div>
			<label>Date of Joining</label>
			 <form:input path="date" class="form-control" placeholder="dd/mm/yyyy" />
                 <small><b><form:errors path="date"
							cssClass="errormsg" /></b></small>
			</div>
