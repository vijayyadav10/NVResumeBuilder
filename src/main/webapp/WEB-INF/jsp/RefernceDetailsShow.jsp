...
<body>
 ...
 <div class="container text-center">
					...
					<a href="refernceDetails" class="btn btn-success">Add
						Another Refernce</a>
					...
					<tbody>
						...
						<c:forEach items="${referncedetailsList }" var="refernce">
							<tr>
								...
								<td>
								<a href="delete/${refernce.id }"><i class="fas fa-trash text-danger" style="font-size: 30px;"></i></a>
								<a href="edit/${refernce.id }"><i class="fas fa-pen-nib text-primary" style="font-size: 30px;"></i></a>
