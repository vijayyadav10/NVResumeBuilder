...
<html>
<head>
<title>NV-Refernce_Details</title>
				...
				<form:form action="handleReferncedetails" id="myForm"
					...
					<div class="form-group">
						...
						<form:input path="refernceName" id="name" cssClass="form-control"
							placeholder="Enter person name" required="required" />
					...
					<div class="form-group">
						...
						<form:input path="designation" size="30" cssClass="form-control"
							placeholder="Enter designation  name" required="required" />
					...
					<div class="form-group">
						...
						<form:textarea path="address" id="address" cssClass="form-control"
							rows="3" placeholder="Enter the address here" required="required" />
					...
					<div class="form-group">
						<form:button type="submit" class="btn btn-primary text-center">Add</form:button>
					</div>
				</form:form>
