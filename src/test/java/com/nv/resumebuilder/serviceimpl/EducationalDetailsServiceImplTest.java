...
public class EducationalDetailsServiceImplTest {
	...
	public void testEducationalDetailsServices() {
		...
		details = new EducationalDetailsEntity(nameOfCollege, degree, university, yearOfPassing, percentage, degreeM,
				collegeNameM, universityM, yearOfPassingM, technicalSkills);
